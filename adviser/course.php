...
$query = "SELECT * FROM fillup INNER JOIN course ON fillup.course_name = course.course_name  WHERE course.course_belong = '$course'";
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" value="<?php echo $courseid ?>">
                                                <button class="btn btn-primary"
                                                    onclick="view('<?php echo $id ?>', '<?php echo $coursename ?>',  '<?php echo $fullname ?>', '<?php echo $courseid ?>')">View</button>
                                            </td>
...
<script>
function view(id, coursename, fullname, courseid) {
    var url = 'viewstudent.php?id=' + id + '&course=' + coursename + '&name=' + fullname + '&courseid=' + courseid;
