...
$query = "SELECT * FROM fillup INNER JOIN course ON fillup.course_name = course.course_name  WHERE course.course_name = 'Bachelor of Secondary Education (Major in Mathematics)'";
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Bachelor of Secondary Education (Major in Mathematics)</li>
                </ol>
                <main>
