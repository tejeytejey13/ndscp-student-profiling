...
$query = "SELECT * FROM fillup INNER JOIN course ON fillup.course_name = course.course_name  WHERE course.course_name = 'Bachelor of Technology and Livelihood Education (Home Economics)'";
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Bachelor of Techonology and Livelihood Education (Home Economics)</li>
                </ol>
                <main>
